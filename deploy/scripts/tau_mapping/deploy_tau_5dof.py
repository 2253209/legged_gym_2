...
class DeployCfg:
    ...
    class robot_config:
        # kps_pos = np.array([160, 160, 160, 160, 36, 36,
        #                 160, 160, 160, 160, 36, 36], dtype=np.double)
        # kds_pos = np.array([10, 10, 10, 10, 2, 2,
        #                 10, 10, 10, 10, 2, 2], dtype=np.double)
        kps_pos = np.array([160, 160, 160, 160, 10, 10,
                        160, 160, 160, 160, 10, 10], dtype=np.double)
        kds_pos = np.array([10, 10, 10, 10, 0.35, 0.35,
                        10, 10, 10, 10, 0.35, 0.35], dtype=np.double)
        kps_tau = np.array([160, 160, 160, 160, 10, 0,
                        160, 160, 160, 160, 10, 0], dtype=np.double)
        kds_tau = np.array([10, 10, 10, 10, 0.7, 0,
                        10, 10, 10, 10, 0.7, 0], dtype=np.double)
        ...
        try:
            ...
            while key_comm.listening:
                ...
                if key_comm.stepCalibrate:
                    ...
                    action_0 = action_net.copy()
                    action_0[4] = np.clip(action_0[4], self.cfg.normalization.clip_pitch_min, self.cfg.normalization.clip_pitch_max)
                    action_0[9] = np.clip(action_0[9], self.cfg.normalization.clip_pitch_min, self.cfg.normalization.clip_pitch_max)
                    action_1[0:5] = action_0[0:5]
                    action_1[6:11] = action_0[5:10]
