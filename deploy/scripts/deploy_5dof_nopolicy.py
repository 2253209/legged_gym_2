...
class DeployCfg:
    ...
    class env:
        ...
        joint_limit_min = np.array([-0.5, -0.25, -1.15, -2.2, -0.8, -0.8,
                                    -0.5, -0.28, -1.15, -2.2, -0.8, -0.8], dtype=np.float32)
        joint_limit_max = np.array([0.5, 0.25, 1.15, -0.05, 0.8, 0.8,
                                    0.5, 0.28, 1.15, -0.05, 0.8, 0.8], dtype=np.float32)
