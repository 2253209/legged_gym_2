...
class DeployCfg:
    ...
    class robot_config:
        ...
        kds = np.array([20, 20, 20, 20, 4, 4, 20, 20, 20, 20, 4, 4], dtype=np.double)
        ...
        try:
            ...
            while key_comm.listening:
                ...
                try:
                    ...
                    # print('zyd_ankle_motor: ', pos_robot[[4, 5, 10, 11]])
                    # print('zyd_ankle_joint: ', pos_net[[4, 5, 10, 11]])
...
if __name__ == '__main__':
    ...
    if not args.load_model:
        args.load_model = f'{LEGGED_GYM_ROOT_DIR}/logs/zq12/exported/policies/20240430/40000.pt'
